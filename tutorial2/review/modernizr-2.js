...
<html>
  <head>
   ...
   <p>
		...
		<img src = "koala.jpg" alt = "Koala Bear" />

   </p>

   <p>
	<a href="html_images.asp">Physical Description</a>
	| <a href="html_images.asp">Location</a>
	| <a href="html_images.asp">Information</a>
   </p>
  ...
  <p>Koalas live in eastern Australia. They require large corridors of connected forest. The habitat of koalas is threatened by urbanization. Koalas live in eucalyptus tree forests. Koalas eat the eucalyptus leaves and most of the water in their diets comes from the leaves or water that is on the leaves.
   ...
   <h2>Information</h2>
	...
	<ul>
		<li><a href="https://www.savethekoala.com/">Australian Koala Foundation</a></li>
		<li><a href="https://en.wikipedia.org/wiki/Koala">Wikipedia - Koalas</a></li>
		<li><a href="http://animals.nationalgeographic.com/animals/mammals/koala/">National Geographic - Koalas</a></li>
	</ul>
